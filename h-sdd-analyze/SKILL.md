...
> **TL;DR** — Gate on completed tasks (0) → cross-check the four artifacts against each other and the constitution (1) → write `analysis.md`, mark done or block, route (2). Read `~/.config/devin/skills/h-sdd/_shared.md` first.
...
- Borrow the rigor of `h-requesting-code-review` for the cross-checks below; this phase does not delegate.
